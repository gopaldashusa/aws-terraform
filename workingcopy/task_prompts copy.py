...
7. FinOps and Cost Optimization Strategies:
   ...
   - Cost monitoring and governance tools
8. WAF Alignments for each component:
...
3. **Analyze WAF Considerations:**
   ...
   - Extract WAF pillars (security, reliability, operational_excellence, performance_efficiency, cost_optimization)
   - Convert each WAF consideration into appropriate Terraform variables
...
- If JSON has "security": "Enable flow logs" → create variable "enable_flow_logs" with default = true
- If JSON has "reliability": "Multi-AZ deployment" → create variable "enable_multi_az" with default = true
