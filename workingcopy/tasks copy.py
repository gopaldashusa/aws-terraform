...
from prompts.task_prompts import PARSE_PROMPT, PLAN_DEPENDENCY_PROMPT, GENERATE_PROMPT, CUSTOMER_PARSE_PROMPT, DESIGN_PROMPT, CUSTOMER_INTENT_PARSE_PROMPT, MODULE_GENERATE_PROMPT, DYNAMIC_VARIABLES_PROMPT, INFRA_PLAN_PROMPT
...
def get_tasks(infra_request: str):
    return [
        ...
        Task(
            ...
            agent=terraform_generator_agent,
            expected_output="A main.tf file with Terraform code using dynamic variables.",
            output_file="output/final/main.tf"
        ),
        Task(
            description=MODULE_GENERATE_PROMPT,
            agent=terraform_module_generator_agent,
            expected_output="Complete Terraform project structure with all modules and resources generated.",
            output_file="output/final/terraform/README.md"
        )
    ]
